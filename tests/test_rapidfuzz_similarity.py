...
from similarity_metrics import rapidfuzz_similarity

class TestRapidFuzzSimilarity(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        print("\nExecuting tests for RapidFuzz Similarity...")

    def test_rapidfuzz_similarity_scenarios(self):
        for true_text, ocr_text, description in TEST_CASES:
            with self.subTest(description=description):
                score = rapidfuzz_similarity(true_text, ocr_text)
